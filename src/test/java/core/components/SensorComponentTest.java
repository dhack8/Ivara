...
public class SensorComponentTest {
    ...
    public void singleConstruct() throws Exception{
        Sensor testSensor = new Sensor(new AABBCollider(new Vector(0,0), new Vector(0,0)));
    ...
    public void arrayConstruct() throws Exception{
        Sensor testSensor1 = new Sensor(new AABBCollider(new Vector(0,0), new Vector(0,0)));

        Sensor testSensor2 = new Sensor(new AABBCollider(new Vector(0,0), new Vector(0,0)));
