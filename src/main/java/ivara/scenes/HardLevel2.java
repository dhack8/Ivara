 ...
 */
public class HardLevel2 extends DefaultLevel {
	public void initialize(){
		...
		// Moving Platforms
		addEntity(new PlatformEntity(new Vector(73,15),new Vector(51,15),10));
		addEntity(new PlatformEntity(new Vector(51,28),new Vector(73,28),10));
		addEntity(new PlatformEntity(new Vector(75,28),new Vector(75,15),6));
