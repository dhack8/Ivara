...
public class Level4 extends DefaultScene {
	public void startScene(){
		...
		addEntity(new BasicTextEntity(new Vector(10.5f,12), new Text(20, "Always try to attack ghosts from above!")));
		...
		// Moving Platforms
		addEntity(new PlatformEntity(new Vector(7,2),2,false,new Vector(9,18),5));
		addEntity(new PlatformEntity(new Vector(47,2),2,false,new Vector(49,18),5));
		addEntity(new PlatformEntity(new Vector(40,18),2,false,new Vector(42,2),5));
