...
public class DoubleJump3 extends Level {
    ...
    public DoubleJump3() {
        super(
                "Double & Beyond",
                "At the end of the northern path, Pablo discovered an enormous alien facility. Outside the facility, there were large obstacle courses. These were set up to test another advanced feature of the boots. Pablo travelled towards the back of the facility. As he moved around he discovered a trash heap of discarded boot augmentations. Pablo's boots now gain energy when he is falling.",
                "Pablo's rocket boots can now recharge additional jumps after the double jump while he is falling.",
                120, 60, 40
        );
    }
